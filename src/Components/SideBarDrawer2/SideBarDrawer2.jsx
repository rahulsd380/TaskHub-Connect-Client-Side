            ...
            <div className="space-y-4">
              ...
              <div>
                <NavLink
                  ...
                  className="text-gray-300 font-semibold hover:text-blue-400 transition duration-300 flex items-center gap-3 mb-3"
                >
                  <AiOutlineFundView></AiOutlineFundView> Task Overview
                </NavLink>
                <div className="px-7">
                  <NavLink
                    to={"/dashboard/todo"}
                    className="text-gray-300 text-sm font-semibold hover:text-blue-400 transition duration-300 flex items-center justify-between gap-3 mb-3 border-b border-gray-400 pb-2"
                  >
