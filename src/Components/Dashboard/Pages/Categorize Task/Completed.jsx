    ...
    return (
        <div className="max-w-7xl mx-auto pb-10">
            ...
            <h1 className="text-3xl font-bold mb-7 pb-3 border-b text-gray-500 flex items-center gap-2"><IoMdDoneAll className="text-teal-500"></IoMdDoneAll> Completed Task List</h1>
            {
                ...
                <div>
            {
                completedLists.length == 0 ? <div className="flex justify-center items-center">
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {
                    completedLists.map(list => <div key={list._id}>
                ...
                <div className="flex justify-between items-center mb-1">
                   ...
                   <button disabled onClick={() => handleMakeCompleted(list)} className="text-gray-400 font-semibold px-4 py-2 bg-gray-300 rounded-md w-full text-center">Task Completed</button>
