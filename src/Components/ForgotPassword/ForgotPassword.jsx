...
const ForgotPassword = () => {
  ...
  const handleResetPassword = (e) => {
    ...
    authContext
      ...
      .then(() => {
        toast.success(
          "Please check your email and click on the link to rest your password.",
          ...
          <form className="p-14">
            <div>
              ...
              <h1 className="text-xl font-bold text-gray-600 mb-1 flex items-center gap-2">
                <PiSmileySadLight></PiSmileySadLight> Forgot your
                <span className="text-blue-400"> Password?</span>
              </h1>
              <p className="text-gray-600 mb-4">
                Enter your email by which you signed up. Then click on the Reset
                button and then check your email. Click on the reset link and
              ...
              <div>
                ...
                <div className="flex justify-center">
                  <Link
                    to={"/login"}
                    className="text-blue-500 font-semibold underline flex items-center gap-2"
                  >
                    <IoReturnUpBackOutline></IoReturnUpBackOutline> Back to
                    login page
                  </Link>
                </div>
              </div>
